...
By default, messages go to your own channel. Use target_jid to send to a different channel (e.g., report results back to the orchestrator).`,
  {
    ...
    target_jid: z
      ...
      .optional()
      .describe(
        'JID of the target channel to send to. Defaults to your own channel. Use this to report results to the orchestrator or other agents.',
      ),
  },
  async (args) => {
    ...
    return {
      content: [
        {
          type: 'text' as const,
          text: `Message sent${args.target_jid ? ` to ${args.target_jid}` : ''}.`,
        },
      ],
    };
  },
